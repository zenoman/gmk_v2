                    ...
                    <div class="item">
                        <div class=" box-in">
                            ...
                            <div class="grid_1 simpleCart_shelfItem">
                                <a href="{{url('/semuaproduk/'.$row->id.'/kategori')}}" class="cup item_add"><span
                                        class=" item_price">{{$row->kategori}}</span></a>
                            </div>
                            <!---->
                        </div>
                    </div>
                            ...
                            <a>
                                ...
                                <div class="zoom-icon">
                                    <ul class="in-by" style="padding-bottom:5px;">
                                        <li>
                                            <h5><b>{{$row->barang}} - {{$row->total}} Pcs</b></h5>
                                        </li>
                                    </ul>
                                    <ul class="in-by">
                                        <li>
            ...
            <div class="content-bottom">
                <div class="col-md-12 latter">
                    ...
                    <div class="text-center">
                        <a href="{{url('/detail-artikel/'.$art->link)}}" class="btn btn-block tombol"
                            style="color: white;">
                            Lanjut Baca
                        </a>
