...
<div class="content">
    <div class="container">
        <br>
        <h2 class="new text-center">PRIVACY POLICY</h2>
        <br>
        <div class="col-md-12">
            ...
            <div class="content-bottom">
                <div class="col-md-12 latter">
                    <div class="text-center">
                        <img src="{{asset('img/web/privacy.png')}}" alt="" width="40%">
                    </div>
                    ...
                    <div>
                        ...
                        <div class="col-md-8">
                            <h1>Privacy Policy for grosir murah kediri</h1>

                            <p>At grosir murah kediri, accessible from www.grosirmurahkediri.com, one of our main
                                priorities is the privacy of our visitors. This Privacy Policy document contains types
                                of information that is collected and recorded by grosir murah kediri and how we use it.
                            </p>
                            ...
                            <p>grosir murah kediri follows a standard procedure of using log files. These files log
                            ...
                            <p>Like any other website, grosir murah kediri uses 'cookies'. These cookies are used to
                            ...
                            <P>You may consult this list to find the Privacy Policy for each of the advertising partners
                                of grosir murah kediri. Our Privacy Policy was created with the help of the <a
                                    href="https://www.privacypolicygenerator.org">Free Privacy Policy Generator</a> and
                                the <a href="https://www.privacypolicyonline.com/privacy-policy-generator/">Privacy
                                    Policy Generator Online</a>.</p>

                            <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web
                                Beacons that are used in their respective advertisements and links that appear on grosir
                                murah kediri, which are sent directly to users' browser. They automatically receive your
                            ...
                            <p>Note that grosir murah kediri has no access to or control over these cookies that are
                                used by third-party advertisers.</p>
                            <br><br>
                            <h2>Third Party Privacy Policies</h2>

                            <p>grosir murah kediri's Privacy Policy does not apply to other advertisers or websites.
                            ...
                            <p>grosir murah kediri does not knowingly collect any Personal Identifiable Information from
                            ...
                            <p>This Privacy Policy applies only to our online activities and is valid for visitors to
                                our website with regards to the information that they shared and/or collect in grosir
                                murah kediri. This policy is not applicable to any information collected offline or via
