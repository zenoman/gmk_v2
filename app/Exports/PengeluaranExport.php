...
class PengeluaranExport implements FromCollection,WithHeadings
{
    ...
    public function collection()
    {
        ...
        ->select(DB::raw('tb_tambahstoks.tgl,tb_tambahstoks.kode_barang,tb_barangs.barang_jenis,tb_varian.varian,tb_tambahstoks.jumlah,tb_kodes.harga_beli,tb_tambahstoks.total,admins.username'))
